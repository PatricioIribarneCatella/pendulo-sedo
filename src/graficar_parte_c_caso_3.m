...
[T U1] = Euler_SEDO('yprima_b', 0, 100, [0.05 -0.05], 0.5);

[T U2] = Runge_Kutta_orden2_SEDO('yprima_b', 0, 100, [0.05 -0.05], 0.5);

[T U3] = Runge_Kutta_orden4_SEDO('yprima_b', 0, 100, [0.05 -0.05], 0.5);
